...
const EMPTY_PAGE_TITLE = "Welcome to Kortix Advanced Workflows";
const EMPTY_PAGE_DESCRIPTION = "Supercharging your Kortix Workers to the next level";
