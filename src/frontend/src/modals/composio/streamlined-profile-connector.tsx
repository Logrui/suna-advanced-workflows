...
import { ComposioCredentialProfileSelector } from '@/modals/composio/composio-credential-profile-selector';
import { ComposioConnector } from '@/modals/composio/composio-connector';
...
export type SetupStep = {
    id: string;
    type: 'composio_profile' | 'mcp_profile';
    service_name: string;
